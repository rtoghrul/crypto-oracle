        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 920, margin: '0 auto', padding: '0 20px 80px' }}>
          ...
          <main style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24, paddingBottom: 20, borderBottom: '1px solid #0d1e30' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                ...
                <div style={{ fontSize: 11, color: '#00ffc860', fontFamily: "'Space Mono', monospace" }}>OpenRouter + Gemma 4 Free</div>
              </div>
            </div>
            ...
            {loading && (
              <div style={{ textAlign: 'center', padding: '48px 0' }}>
                ...
                <div style={{ color: '#1e3248', fontSize: 11, marginTop: 8 }}>Analyzing prompt · Synthesizing outlook · Generating signal</div>
              </div>
            )}
          ...
          <section style={{ marginTop: 48, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 14 }}>
            {[
              ...
              { icon: '🧠', title: 'AI Analysis', desc: 'Gemma synthesizes structured crypto insights' },
